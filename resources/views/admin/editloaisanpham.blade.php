        ...
        <form action="{{URL::to('/update-loai-san-pham/'.$lsp->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" value = "{{$lsp->ma_loai}}" name="ma_loai" style="width: 300px" placeholder="Nhập mã loại sản phẩm" class="form-control">
                </div>
            </div>
                <div class="row form-group">
                <div class="col col-md-3">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" value ="{{$lsp->ten_loai}}" name="ten_loai" style="width: 300px" placeholder="Nhập tên loại sản phẩm" class="form-control">
                </div>
            </div>
